/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8f08ea8dfed21739a66af2ddd00fdf0b)
// Runtime types generated with workerd@1.20251011.0 2025-11-04 enable_ctx_exports,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TestAgent";
	}
	interface Env {
		R2_PUBLIC_URL: string;
		OPENROUTER_API_KEY: string;
		TEST_AGENT: DurableObjectNamespace /* TestAgent from gameeval-qa-pipeline */;
