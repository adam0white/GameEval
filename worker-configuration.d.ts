/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 79f74557c02d17d8cd4fd40eec62e1d9)
// Runtime types generated with workerd@1.20251011.0 2025-11-04 enable_ctx_exports,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TestAgentV2";
	}
	interface Env {
		R2_PUBLIC_URL: string;
		OPENROUTER_API_KEY: string;
		TEST_AGENT: DurableObjectNamespace /* TestAgentV2 from gameeval-qa-pipeline */;
		EVIDENCE_BUCKET: R2Bucket;
		DB: D1Database;
		BROWSER: Fetcher;
		AI: Ai;
		ASSETS: Fetcher;
		WORKFLOW: Workflow<Parameters<import("./src/index").GameTestPipeline['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_URL" | "OPENROUTER_API_KEY">> {}
}
